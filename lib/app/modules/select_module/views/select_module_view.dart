  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          ...
          title: const Text("Select Module",style: TextStyle(fontWeight: FontWeight.w600),),
          centerTitle: true,
        ...
        body: Container(
          ...
          child: ListView(children: const [
            ...
            SelectModuleItem(text: "OOp"),
            SelectModuleItem(text: "SE"),
            SelectModuleItem(text: "DSA"),
            SelectModuleItem(text: "MM"),
            SelectModuleItem(text: "OOAD"),
          ],
          ),
        ),
      );
